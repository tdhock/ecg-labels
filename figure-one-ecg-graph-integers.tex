...
\path[every node/.style={font=\sffamily\small}]
 (Q) edge [bend left] node [above] {$1, 2$} node [below] {$\beta$} (R)
 (R) edge [bend left] node [above] {$-1, 5$} node [below] {} (S)
 (S) edge [bend left] node [above] {$1, 2$} node [below] {} (o1)
 (o1) edge [bend left] node [above] {$1, 1$} node [below] {} (o2)
 (o2) edge [bend left] node [above] {$1, 0$} node [below] {} (o3)
 ...
 (o6) edge [bend left, looseness=0.5] node [above] {$-1, 0$} node [below] {} (Q)
 ;
\end{tikzpicture}
